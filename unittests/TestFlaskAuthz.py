...
class TestFlaskAuthz(unittest.TestCase):
    ...
    def test_group_has_editor(self):
                    ...
                    [
                        {
                            ...
                            "name": "Editor",
                            "players": [
                                "uid:specific_xpp123456_editor",
                                "ps_xpp123456_editors",
                            ],
                        },
                        {
                            "app": "LogBook",
                            "name": "Reader",
                            "players": [
                                "uid:specific_xpp123456_reader",
                                "ps_xpp123456_readers",
                            ],
                        },
                    ]
                ),
                    ...
                    [
                        {
                            ...
                            "name": "Editor",
                            "players": [
                                "uid:specific_mec987654_editor",
                                "ps_mec987654_editors",
                            ],
                        },
                        {
                            "app": "LogBook",
                            "name": "Reader",
                            "players": [
                                "uid:specific_mec987654_reader",
                                "ps_mec987654_readers",
                            ],
                        },
                    ]
                ),
                    ...
                    [
                        {
                            ...
                            "name": "Editor",
                            "players": [
                                "uid:specific_restricted_editor",
                                "ps_restricted_editors",
                            ],
                        },
                        {
                            "app": "LogBook",
                            "name": "Reader",
                            "players": [
                                "uid:specific_restricted_reader",
                                "ps_restricted_readers",
                            ],
                        },
                    ]
                ),
        ...
        with app.test_request_context("/"):
            with self.assertRaises(HTTPException) as http_error:
                self.assertRaises(
                    ...
                    security.authentication_required(
                        part("Should not have authenticated....")
                    )(),
                )
            ...
            self.assertTrue(
                security.authentication_required(part("Authenticated...."))()
            )
            self.assertTrue(
                security.authorization_required("read")(part)(
                    "Authorized", **{"experiment_name": "xpp123456"}
                )
            )
            with self.assertRaises(HTTPException) as http_error:
                self.assertFalse(
                    security.authorization_required("edit")(part)(
                        "Authorized", **{"experiment_name": "xpp123456"}
                    )
                )
                self.assertTrue(
            ...
            with self.assertRaises(HTTPException) as http_error:
                self.assertFalse(
                    security.authorization_required("read")(part)(
                        "Authorized", **{"experiment_name": "mec987654"}
                    )
                )
                self.assertEqual(http_error.exception.code, 403)
            with self.assertRaises(HTTPException) as http_error:
            ...
            with self.assertRaises(HTTPException) as http_error:
                self.assertFalse(
                    security.authorization_required("read")(part)("Authorized", **{})
                )
                self.assertEqual(http_error.exception.code, 403)
        ...
        with app.test_request_context("/"):
            ...
            self.assertTrue(
                security.authorization_required("experiment_switch")(part)("Authorized")
            )
        ...
        with app.test_request_context("/"):
            ...
            with self.assertRaises(HTTPException) as http_error:
                self.assertFalse(
                    security.authorization_required("experiment_switch")(part)(
                        "Authorized"
                    )
                )
                self.assertEqual(http_error.exception.code, 403)
        ...
        with app.test_request_context("/"):
            ...
            self.assertTrue(
                security.authorization_required("read")(part)(
                    "Authorized", **{"experiment_name": "restricted_experiment"}
                )
            )
            self.assertTrue(
                security.authorization_required("edit")(part)(
